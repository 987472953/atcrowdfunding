...
public interface TAdminRoleMapper {
	...
	void saveAdminRoleRelationship(@Param(value = "roleIds")Integer[] roleId,@Param(value = "adminId") Integer adminId);

	void deleteAdminRoleRelationship(@Param(value = "roleIds")Integer[] roleId,@Param(value = "adminId") Integer adminId);
}